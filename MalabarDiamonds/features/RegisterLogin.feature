...
Background: 
   Given User is on Malabar Golds & Diamonds page "https://www.malabargoldanddiamonds.com/"
 
   @ValidCredentials
   Scenario: Login with valid credentials
    When user press the profile 
    When user click on the Login button
    When User enters username as "wakeye8520@chotunai.com" and password as "wakeye@8520"
